...
public class GameMain {
	...
	public static boolean allowBet(int credit, int bet) {
		if (bet > credit) {
			return false;
		} else {
			return true;
	...
	public static boolean ifWin(int playerHand, int system) {
		boolean ifWin = false;
		if (playerHand > system || playerHand == 21) {
			ifWin = true;
		}
	...
	Cards card1 = new Cards(Suits.valueOf("Clubs"),11);	
	Cards card2 = new Cards(Suits.valueOf("Clubs"),11);	
	public static boolean ifSplit(Cards cardOne, Cards cardTwo){
